    ...
    <AnimatePresence>
      {!showCollapsed ? (
        ...
        >
          ...
          <motion.div 
            className="px-5 py-4 border-b border-slate-200/60 dark:border-slate-700/60 bg-gradient-to-r from-slate-50 via-white to-slate-50 dark:from-slate-700/40 dark:via-slate-800/40 dark:to-slate-700/40"
