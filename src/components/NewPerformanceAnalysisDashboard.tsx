      ...
      <header className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="mt-4 sm:mt-0">
          <button
            ...
            className="w-full sm:w-auto bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-6 rounded-lg shadow-lg hover:shadow-indigo-400/50 transition-all duration-300 ease-in-out disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {isNavigating && (
            ...
            {isNavigating ? 'Loading...' : 'View Solution'}
          </button>
        </div>
      </header>
