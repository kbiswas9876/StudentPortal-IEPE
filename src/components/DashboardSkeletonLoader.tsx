  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
      <div className="container mx-auto px-4 py-4 sm:py-8">
        ...
        >
          <div className="h-8 sm:h-12 bg-slate-200 dark:bg-slate-700 rounded w-64 sm:w-80 mx-auto mb-4 animate-pulse"></div>
          <div className="h-4 sm:h-6 bg-slate-200 dark:bg-slate-700 rounded w-96 sm:w-[32rem] mx-auto animate-pulse"></div>
        </motion.div>
        ...
        <div className="space-y-4 sm:space-y-6 lg:space-y-0 lg:grid lg:grid-cols-5 lg:gap-8 lg:min-h-[calc(100vh-16rem)] pb-24 sm:pb-20 lg:pb-0">
          {/* Left Column - Books & Chapters Skeleton */}
          <motion.div
          ...
          {/* Right Column - Settings & Summary Skeleton */}
          <motion.div
            initial={{ opacity: 0, x: 20 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.3, delay: 0.2 }}
            className="lg:col-span-2 flex flex-col space-y-4 lg:max-h-[calc(100vh-20rem)] lg:overflow-y-auto lg:pr-2"
          >
        ...
        <motion.div
          ...
          className="fixed bottom-0 left-0 right-0 bg-white dark:bg-slate-800 border-t border-slate-200 dark:border-slate-700 p-4 shadow-lg"
        >
