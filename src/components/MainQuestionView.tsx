        ...
        <div className="flex items-center gap-1">
          ...
          >
            {isBookmarked ? (
              ...
              <svg className="w-5 h-5 text-slate-500 dark:text-slate-300" viewBox="0 0 20 20" fill="currentColor">
                <path d="M5 3a2 2 0 012-2h6a2 2 0 012 2v15l-6-3-6 3V3z" />
              </svg>
            )}
          </button>
          ...
          >
            <svg className="w-5 h-5 text-slate-600 dark:text-slate-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l-3 2-4-3-4 2v8l4-2 4 3 3-2V8z" />
            </svg>
          </button>
        </div>
      </div>
