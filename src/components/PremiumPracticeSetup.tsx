          ...
          <div className="lg:col-span-4 flex flex-col">
            ...
            >
              ...
              <motion.div
                ...
                className="bg-white rounded-xl border border-warm-border p-4 sm:p-5 claude-card"
              >
                <h3 className="text-base sm:text-lg font-semibold text-charcoal mb-3 sm:mb-4">
                  Session Settings
                </h3>
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="space-y-2 sm:space-y-3">
                    <label className="block text-sm font-medium text-charcoal-mid">
                      Question Order
                    </label>
                    <SegmentedControl
                  ...
                  <div className="space-y-2 sm:space-y-3">
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-between px-4 py-3 bg-warm-surface hover:bg-warm-hover border border-warm-border rounded-lg transition-all duration-200"
                    >
                      <div className="flex items-center gap-3">
                        <svg className="w-5 h-5 text-charcoal-mid" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          {hideMetadata ? (
                        ...
                        <span className="text-sm font-medium text-charcoal-mid">
                          {hideMetadata ? 'Hide' : 'Show'} Question Metadata
                        </span>
                      </div>
                      <div className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${hideMetadata ? 'bg-charcoal-muted' : 'bg-terra'}`}>
                        <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${hideMetadata ? 'translate-x-1' : 'translate-x-6'}`} />
                      </div>
                    </button>
                    <p className="text-xs text-charcoal-muted flex items-center gap-1">
                      ...
                      <span>{hideMetadata ? 'Metadata (exam source, tags) will be hidden' : 'Metadata (exam source, tags) will be shown'} during practice</span>
                    </p>
                  </div>
                </div>
              </motion.div>
